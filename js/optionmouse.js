            ...
            '<div class="_mouse-background">' +
                '<div class="_mouse-container-modal">' +
                    '<div class="_mouse-modal animated pulse">' +
                        ...
                        '<div class="_mouse-header"><p><span>Wait!</span><br/>Join this site with<br/><strong>30% discount</strong></p></div>'+
                        '<div class="_mouse-content">' +
                            '<span class="_mouse-con-1">for just</span><br/>' +
                            '<span class="_mouse-con-2">39.95$</span><br/>' +
                            '<span class="_mouse-con-3">24.95$</span><br/>' +
                            '<p class="_mouse-con-4">per month</p>' +
                            '<a href="#" class="_mouse-con-btn">GET DISCOUNT</a>' +
                        '</div>'+
                    '</div>' +
                '</div>' +
            '</div>',
